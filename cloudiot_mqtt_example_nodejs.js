...
function publishAsync (messagesSent, numMessages) {
  ...
  setTimeout(function () {
    const payload = `{"sensorID":"${argv.deviceId}","timecollected":"${getReadingTime()}","zipcode":"4060","latitude":"-27.448735","longitude":"152.974652","temperature":"${getRandomArbitrary(20, 22)}","humidity":"${getRandomArbitrary(20, 22)}","dewpoint":"${getRandomArbitrary(35, 37)}","pressure":"${getRandomArbitrary(20, 25)}"}`;
